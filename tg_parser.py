...
PHONE    = "+7"  # ← ВСТАВЬ СВОЙ НОМЕР ТЕЛЕФОНА (с кодом страны)
...
CHATS = [
    "smm_ru",          # SMM специалисты
    "marketing_ru",    # Маркетинг
    "freelance_ru",    # Фриланс
    "biznes_online",   # Бизнес онлайн
    # Добавляй свои чаты сюда
]

# Ключевые слова — если сообщение содержит одно из них → лид
KEYWORDS = [
    "ищу smm", "нужен smm", "ищу маркетолога", "нужен маркетолог",
    "ищу продвижение", "нужно продвижение", "помогите с рекламой",
    "кто занимается контентом", "ищу специалиста по контенту",
    "нужен reels", "нужны reels", "снять reels",
    "продвижение instagram", "продвижение инстаграм",
    "нужен таргетолог", "ищу таргетолога",
    "помогите с инстаграм", "раскрутить инстаграм",
