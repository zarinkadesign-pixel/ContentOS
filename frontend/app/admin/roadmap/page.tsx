...
const COMPETITORS = [
  {
    ...
    features: ["Workflow автоматизация", "400+ интеграций", "Self-hosted / Cloud", "Webhooks, cron"],
    missing: ["Нет CRM", "Нет AI контента", "Нет видео", "Нет Telegram бота"],
    apiSecurity: "API key + webhook signature",
    score: 6,
  ...
  },
  {
    ...
    category: "Автоматизация",
    price: "$9–$29/мес",
    features: ["Visual workflow builder", "1000+ интеграций", "Real-time execution", "Error handling"],
    missing: ["Нет AI генерации", "Нет CRM", "Нет видео", "Нет Telegram"],
    apiSecurity: "OAuth 2.0 + API keys",
    score: 5,
  ...
  },
  {
    ...
    category: "Видео AI",
    price: "$29–$89/мес",
    features: ["Авторезка видео", "Субтитры", "Reels/Shorts", "Brand kit"],
    missing: ["Только видео", "Нет CRM", "Нет автоматизации", "Нет Telegram"],
    apiSecurity: "API key + rate limiting",
    score: 6,
    target: "Контент-криейторы",
  },
  {
    name: "Highswivel (Highswell)",
    logo: "📈",
    category: "AI Marketing",
    price: "$49–$149/мес",
    features: ["AI контент", "Multi-platform", "Analytics", "Scheduling"],
    missing: ["Нет Telegram", "Нет CRM", "Нет видео", "Нет lead scoring"],
    apiSecurity: "API key encryption",
    score: 6,
    target: "Маркетологи",
  },
  {
    ...
    price: "$45–$1200/мес",
    features: ["Full CRM", "Email marketing", "Analytics", "Automation"],
    missing: ["Очень дорого", "Нет AI видео", "Нет Telegram", "Сложный onboarding"],
    apiSecurity: "OAuth 2.0 + private apps + HTTPS only",
    score: 8,
  ...
  },
  {
    ...
    price: "$15–$65/мес",
    features: ["Instagram / Telegram боты", "Flow builder", "Broadcasting", "AI intent"],
    missing: ["Только мессенджеры", "Нет контента", "Нет видео", "Нет CRM полного"],
    apiSecurity: "API key + webhook validation",
    score: 6,
    target: "E-commerce, блогеры",
  },
  {
    name: "ContentStudio",
    logo: "📱",
    ...
    price: "$25–$99/мес",
    features: ["AI контент", "Scheduling", "Analytics", "Multi-platform"],
    missing: ["Нет CRM", "Нет видео", "Нет Telegram", "Нет lead scoring"],
    apiSecurity: "API keys + rate limiting",
    score: 6,
    target: "Агентства, SMM",
  },
  {
    name: "Opus Clip",
    logo: "✂️",
    category: "Видео AI",
    price: "$15–$49/мес",
    features: ["AI клипы из длинных видео", "Virality score", "Captions", "Reframe"],
    missing: ["Только видео", "Нет CRM", "Нет автоматизации", "Нет Telegram"],
    apiSecurity: "API key + HTTPS",
    score: 6,
    target: "Подкастеры, YouTubers",
  },
  {
    ...
    features: [
      ...
      "CRM + Lead scoring",
      "Telegram бот + автоответы",
      "Видео AI (Vizard интеграция)",
      "n8n автоматизации (17 воркфлоу)",
      "Multiplatform публикация",
      "Ежемесячные отчёты",
      "Engine 24/7 автопилот",
    ],
    missing: ["Пока прототип", "Нет мобильного приложения", "Русскоязычный рынок"],
    apiSecurity: "Multi-layer: env vars + HMAC + JWT + rate limiting + prompt injection defense",
    score: 9,
...
const INVESTMENT_INFO = [
  {
    ...
    where: "AngelList, Republic, личная сеть, LinkedIn, акселераторы Y Combinator, 500 Startups",
    terms: "Convertible note (SAFE) — конвертируется в акции при следующем раунде. Самый мягкий инструмент для основателя.",
    color: "text-[#C8F135]",
    bestFor: true,
  },
  {
    stage: "Seed Round",
    amount: "$500k–$3M",
    investor: "Seed VC фонд",
    equity: "15–25%",
    when: "MVP готов, есть $1–5k MRR",
    where: "Seedcamp, Techstars, локальные VC фонды (Казахстан, Россия, США)",
    terms: "Priced equity round (Series Seed). Оценка компании $3–10M pre-money.",
    color: "text-blue-400",
    bestFor: false,
  },
  {
    ...
    equity: "20–30%",
    when: "Product-market fit доказан, $100k+ MRR",
    where: "a16z, Sequoia, Battery Ventures, региональные VC",
    terms: "Прайсированный раунд. Полный due diligence. Входит в совет директоров.",
    color: "text-purple-400",
    bestFor: false,
  },
];
