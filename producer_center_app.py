...
SENDPULSE_ID     = "sp_id_9855a89ce35b1322b385bb3fbe683960"
SENDPULSE_SECRET = "sp_sk_d9ebdeff7564cefa765ba3e264b56c27"
BOT_TOKEN        = "8494012171:AAFTbhHTS0WxlG6PE6DRn96nVVF4kKfBKtY"
TG_API_ID        = "39690892"
TG_API_HASH      = "49c256e3b000ace4972908fad43380ce"
KPI_TARGET       = 20000
# ═══════════════════════════════════════
#  CONFIG
# ═══════════════════════════════════════
        ...
        for num,title,color in [("1","📤 URL видео",ACCENT),("2","✂️ Клипы",ORANGE),
            ...
            if num=="1":
                ...
                def step1():
                    ...
                    self._clips = DEMO
                    self._btn2.configure(state="normal",fg_color=CARD2,text_color=ORANGE)
                ctk.CTkButton(row,text="⚡ Отправить",font=("Inter",11,"bold"),
                              fg_color=CARD2,hover_color=BORDER2,text_color=ACCENT2,
                ...
                def step2():
                    ...
                    self._btn3.configure(state="normal",fg_color=CARD2,text_color=CYAN)
                ...
                def step3():
                    ...
                    def show_caps():
                        ...
                        self._btn4.configure(state="normal",fg_color=CARD2,text_color=PINK)
                    threading.Thread(target=do,daemon=True).start()
